...
def _report_type(r) -> Optional[str]:
    ...
    create_study records this in prediction_json. Reports generated before that
    was added carry no marker, and this returns None rather than assuming
    "clinical" — the UI renders its variant chips neutral on None instead of
    claiming a variant was generated when we do not know.
    """
    if r is None:
        return None
